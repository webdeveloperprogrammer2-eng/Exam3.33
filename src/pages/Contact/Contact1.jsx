...
export default function ContactSection() {
    ...
    return (
        <>
            <h1 className='text-white text-6xl' style={{marginLeft:'80px', marginTop:'30px', marginBottom:'30px'}}>
                {t('contact.title')}
            </h1>
                        ...
                        <Box className="w-full max-w-md bg-[#222222] text-white p-12 pointer-events-auto flex flex-col gap-8 shadow-2xl">
                            <Box className="flex flex-col gap-4">
                                <Typography variant="h4" sx={{ fontFamily: 'inherit', fontWeight: 700 }}>
                                    {t('contact.location.city')}, <span className="text-[#f5c742]">{t('contact.location.country')}</span>
                                </Typography>
